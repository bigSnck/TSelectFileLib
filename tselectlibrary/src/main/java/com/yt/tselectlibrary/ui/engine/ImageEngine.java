package com.yt.tselectlibrary.ui.engine;
...
public interface ImageEngine {
     ...
     */
    void loadThumbnail(Context context, int resize,ImageView imageView, String uri);
     ...
     * @param uri         Uri of the loaded image
     */
    void loadGifThumbnail(Context context, int resize, ImageView imageView, String uri);
